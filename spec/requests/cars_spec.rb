  ...
  describe 'POST /cars' do
    ...
    context 'with valid params' do
      it 'creates a new Car and redirects' do
        ...
        expect do
          post cars_path,
               params: { car: { year_id: year_2022.id, model_id: series_3.id, make_id: bmw.id,
                                dealership_id: bmw_dealership.id } }
    ...
    context 'with invalid params' do
      it 'does not create a new Car and re-renders the form with errors' do
        ...
        expect do
          post cars_path,
               params: { car: { year: nil, model_id: nil, make_id: bmw.id, dealership_id: bmw_dealership.id } }
